...
import type { Profile as _Profile, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, WorkItem as _WorkItem } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addWorkItem(arg0: {
        ...
        if (this.processError) {
            try {
                const result = await this.actor.addWorkItem(to_candid_record_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteWorkItem(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteWorkItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllWorkItems(): Promise<Array<WorkItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllWorkItems();
    ...
    async getVideoWorkItems(): Promise<Array<WorkItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoWorkItems();
                return from_candid_vec_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWorkItem(arg0: bigint): Promise<WorkItem | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getWorkItem(arg0);
    ...
    async reorderWorkItems(arg0: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderWorkItems(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProfile(arg0: Profile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProfile(to_candid_Profile_n19(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_WorkItem_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WorkItem): WorkItem {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WorkItem]): WorkItem | null {
    return value.length === 0 ? null : from_candid_WorkItem_n5(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        date: value.date,
        link: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.link)),
...
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WorkItem>): Array<WorkItem> {
    return value.map((x)=>from_candid_WorkItem_n5(_uploadFile, _downloadFile, x));
}
